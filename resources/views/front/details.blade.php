...
@section('title', 'Milzha Portofolio')
@section('content')
...
<section id="Header" class="flex flex-col gap-[100px] bg-portto-black relative max-h-[665px] mb-[493px]">
    ...
    {{-- <section id="Videos" class="container max-w-[1130px] mx-auto pt-[50px]">
    <div class="flex flex-col gap-5">
        <h2 class="font-extrabold text-2xl">Videos</h2>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
            <!-- Video 1 -->
            <div class="group w-full h-[190px] overflow-hidden rounded-[30px] ring-1 ring-[#E4E5E8] transition-all duration-300 hover:ring-[3px] hover:ring-portto-purple relative">
                <a data-fancybox="video-gallery" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" data-caption="Video #1">
                    <div class="relative w-full h-full">
                        <img src="../assets/images/thumbnails/video1.jpg" class="w-full h-full object-cover" alt="video thumbnail">
                        <img src="../assets/images/icons/play.svg" class="absolute transition-all duration-300 opacity-0 group-hover:opacity-100 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 z-10" alt="play icon">
                    </div>
                </a>
            </div>
            ...
            <!-- Video 2 -->
            <div class="group w-full h-[190px] overflow-hidden rounded-[30px] ring-1 ring-[#E4E5E8] transition-all duration-300 hover:ring-[3px] hover:ring-portto-purple relative">
                <a data-fancybox="video-gallery" href="../assets/videos/sample.mp4" data-caption="Video #2">
                    <div class="relative w-full h-full">
                        <img src="../assets/images/thumbnails/video2.jpg" class="w-full h-full object-cover" alt="video thumbnail">
                        <img src="../assets/images/icons/play.svg" class="absolute transition-all duration-300 opacity-0 group-hover:opacity-100 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 z-10" alt="play icon">
                    </div>
                </a>
            </div>
