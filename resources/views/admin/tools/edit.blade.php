    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.tools.update', $tools) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="flex flex-col gap-y-5">
                        ...
                        <div class="flex flex-col gap-y-2">
                            <h3>Name</h3>
                            <input value="{{ $tools->name }}"  type="text" id="name" name="name" class="border rounded px-4 py-2">
                        </div>

                        {{-- Tagline Field --}}
                        <div class="flex flex-col gap-y-2">
                            <h3>Tagline</h3>
                            <input value="{{ $tools->tagline }}" type="text" id="tagline" name="tagline" class="border rounded px-4 py-2">
                        </div>
                        ...
                        <div class="flex flex-col gap-y-2">
                            ...
                            <img src="{{ Storage::url($tools->logo) }}" alt="" class="object-cover w-[120px] h-[90px] rounded-2xl">
